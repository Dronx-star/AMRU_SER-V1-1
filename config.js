...
module.exports = {
    ...
    SESSION: process.env.AMRU_CODE === undefined ? '' : process.env.AMRU_CODE,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '💖Amru-Ser💖' : process.env.OWNER_NAME,
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Amru,Ser' : process.env.DEPLOYER,
    ...
    AFPLK: process.env.SANA_PASSWORD === undefined ? false : process.env.AMRU_PASSWORD,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ 💝 Amru-Ser 💝 ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'Abu' : process.env.BOT_NAME,
    ...
    TALKING_AMRU: process.env.TALKING_AMRU === undefined ? 'false' : process.env.TALKING_AMRU,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'Amru💞/💝/✨/📝' : process.env.CMD_LIST,
